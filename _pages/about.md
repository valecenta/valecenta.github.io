...
Research 
------
So far, my research has focused on **how humans perceive durations in the millisecond range**. By casting time as a sensory feature extracted from the environment, I aim to understand its neural processing at a mechanistic level and how it interacts with other sensory features. I investigate vision as a model system, asking how duration information is [extracted from visual inputs](https://doi.org/10.1038/s41467-024-54336-5), how it is [integrated with co-occurring spatial information](https://doi.org/10.1038/s41467-024-54336-5) and [prior temporal context](https://doi.org/10.1167/jov.25.9.2496), and how these processes ultimately support [time perception and temporal judgments](https://doi.org/10.1371/journal.pbio.3003704). To address these questions, I combine **psychophysics**, **7T functional MRI**, and computational approaches based on **neuronal modelling**.
